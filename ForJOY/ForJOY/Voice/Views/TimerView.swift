    ...
    var body: some View {
        ...
        ZStack{
            ...
            VStack{
                ...
                ZStack{
                    ...
                    if !vm.isRecording && !vm.isEndRecording {
                        ...
                        ZStack{
                            ...
                            RecAnimationView(vm: vm, rt: rt, decibels: $decibels)
                                .mask{
                                    Circle()
                ...
                Text("Time\(rt.timeString(from: rt.remainingTime))") // 임시로 표기
        ...
        .onReceive(timer2) { _ in
            if !vm.isEndRecording{
                if vm.isRecording && rt.remainingTime > 0 {
                    rt.remainingTime -= 1
                    recProgress += (1/settingTime)
                } else if rt.remainingTime <= 0 {
                    vm.isRecording = false
                    vm.isEndRecording = true
                    vm.stopRecording()
                }
