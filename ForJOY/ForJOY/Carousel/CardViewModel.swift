...
class CardViewModel: ObservableObject {
    ...
    @Published var cardData: [CardModel] = [
        ...
        CardModel(recordImage: "2", recordName: "와앙~~~~~~~~", recordDate: "2023.04.12", recordAudio: "I AM", idx: 2),
        CardModel(recordImage: "3", recordName: "알 유 마조리카?", recordDate: "2023.03.13", recordAudio: "Overnight", idx: 3),
        CardModel(recordImage: "4", recordName: "아기상어 타투", recordDate: "2023.02.14", recordAudio: "I AM", idx: 4),
        CardModel(recordImage: "5", recordName: "카와이 베이비😍", recordDate: "2023.01.15", recordAudio: "Overnight", idx: 5),
        CardModel(recordImage: "6", recordName: "사진 사이즈 조정하는법;;", recordDate: "2022.12.16", recordAudio: "I AM", idx: 6),
    ...
    init() {
        self.players = cardData.map{ AVPlayer(url: URL(fileURLWithPath: Bundle.main.path(forResource: $0.recordAudio, ofType: "mp3")!)) }
    }
}
